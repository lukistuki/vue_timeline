...
/***/ (function(module, exports, __webpack_require__) {
	...
	// include components
	Vue.component('si-timeline', __webpack_require__(123));
	Vue.component('si-event', __webpack_require__(126));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(122), (function() { return this; }())))
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    progress: function progress() {
	      var progressBarDaysSinceStart = this.timeStamps.currentDate.diff(this.timeStamps.startDate, 'days');
	      var timelineDaysNumber = this.numberOfDays;

	      var calculatedWidth = progressBarDaysSinceStart / timelineDaysNumber * 90; // 90% axis width
	      return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('section', {
	    ...
	    staticClass: "axis"
	  }, _vm._l((_vm.timeline.events), function(event) {
	    return _c('si-event', {
	      attrs: {
	        "date": event[0],
	        "name": event[1],
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    setPosition: function setPosition() {
	      var eventDaysSinceStart = this.eventDate.diff(this.timeStamps.startDate, 'days');
	      var timelineDaysNumber = this.numberOfDays;

	      var calculatedPosition = eventDaysSinceStart / timelineDaysNumber * 100 * 0.9 + 5; // 0.9 => 90% widh axis, +5 => per 5% axis side margins
	      return {
	  ...
	  computed: {
	    ...
	    formattedDateTimeAttribute: function formattedDateTimeAttribute() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('li', {
	    ...
	    attrs: {
	      "datetime": _vm.formattedDateTimeAttribute
	    }
